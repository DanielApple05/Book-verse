           ...
           <div className='xl:flex grid grid-cols-2  gap-4 w-full'>
            {recommendedBooks?.map((item) => (
              <div 
                ...
                key={item.id} className='w-full sm:w-1/2 xl:w-1/3 2xl:w-1/4 ring ring-amber-100 rounded-lg shadow-xl hover:shadow-2xl hover:-translate-y-1 cursor-pointer xl:h-full'>
