...
const Header = () => {
  ...
  return (
    <div className='flex items-center justify-between p-4 border-b xl:text-2xl text-sm border-gray-200 w-full fixed top-0 z-50 bg-white dark:bg-gray-900 dark:border-gray-700'>
      <Logo />
      ...
      <div className='flex items-center gap-3'>
        <FontAwesomeIcon
          ...
          className='cursor-pointer text-[#1A1A2E] text-2xl dark:text-white'
        />
        {user ? (
