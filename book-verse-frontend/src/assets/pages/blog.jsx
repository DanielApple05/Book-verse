    ...
    <>
     <Header /> 
      <div style={{ backgroundImage: 'url(/images/about-us-hero.png)' }} className='bg-cover bg-center h-[80vh] relative bg-no-repeat mt-16'>
        ...
        <div className='absolute inset-0 flex flex-col justify-center xl:p-10 p-5 xl:w-[40%] w-full space-y-5 '>
          ...
          <Link to='/home' className='bg-amber-600 p-2 rounded-lg w-20 text-center  cursor-pointer hover:bg-amber-950 font-bold '>Home</Link>
        </div>
      </div>
      <MobileNavBar />
      <Footer />
