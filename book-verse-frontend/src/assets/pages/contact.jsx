...
const Contact = () => {
  return (
    <>
      <Header />
      <div style={{ backgroundImage: 'url(/images/contact-hero.png)' }} className='bg-cover bg-center h-72 lg:h-[80vh] relative bg-no-repeat mt-16'>
      ...
      <div className='flex flex-col xl:flex-row'>
        ...
        <div className='xl:w-[50%] w-full xl:p-10 p-5'>
          hello
        </div>
      </div>
      <Footer />
